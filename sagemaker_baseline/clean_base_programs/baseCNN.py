...
class Model:
    ...
    def __init__(self):
        ...
        hook.add_to_collection("inputs", self.images)
        self.n_classes = 10
        ...
        self.data_loss = tf.losses.softmax_cross_entropy(self.labels, self.logits)
...
if __name__ == "__main__": 
    ...
    train_data_loader = DataLoaderFromArrays(x_train, y_train, shuffle=True, one_hot=True, normalization=False)
    test_data_loader = DataLoaderFromArrays(x_test, y_test, shuffle=True, one_hot=True, normalization=False)
    # start the training.
