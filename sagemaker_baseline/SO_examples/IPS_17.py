...
if __name__ == "__main__": 
    ...
    train_data_loader = DataLoaderFromArrays(x_train, y_train, shuffle=True, one_hot=False, normalization=False, problem_type='regression')
    test_data_loader = DataLoaderFromArrays(x_train, y_train, shuffle=True, one_hot=False, normalization=False, problem_type='regression')
    # start the training.
