...
class Model:
    ...
    def __init__(self, hook):
        ...
        self.data_loss = tf.reduce_mean(-tf.reduce_sum(self.labels*tf.log(tf.clip_by_value(self.outputs, 1e-10, 1.0))))
...
if __name__ == "__main__":
    ...
    train_data_loader = DataLoaderFromArrays(X_train, y_train, problem_type='regression', shuffle=True, one_hot=False, normalization=True, homogeneous=False)
    test_data_loader =  DataLoaderFromArrays(X_test, y_test, problem_type='regression', shuffle=True, one_hot=False, normalization=True, homogeneous=False)
