...
class Model:
    ...
    def build(self, features, n_classes, reuse=False, is_training=False):
        with tf.variable_scope('lenet', reuse=reuse):
            ...
            conv1_reg = tf.layers.dropout(inputs=conv1_norm, rate=0.5, training=is_training)
            conv2 = tf.layers.conv2d(inputs=conv1_reg,
                                    filters=32,
                                    kernel_size=[3, 3], 
                                    padding='same',
                                    activation=tf.nn.relu,
            ...
            reg_pool2 = tf.layers.dropout(inputs=pool2, rate=0.5, training=is_training)
            ...
            conv3_reg = tf.layers.dropout(inputs=conv3_norm, rate=0.5, training=is_training)
            conv4 = tf.layers.conv2d(inputs=conv3_reg, 
                                    filters=64, 
                                    kernel_size=[3, 3],
                                    padding='same', 
                                    activation=tf.nn.relu,
            ...
            reg_pool4 = tf.layers.dropout(inputs=pool4, rate=0.5, training=is_training)
            ...
            conv5_reg = tf.layers.dropout(inputs=conv5_norm, rate=0.5, training=is_training)
            conv6 = tf.layers.conv2d(inputs=conv5_reg, 
                                    filters=128, 
                                    kernel_size=[3, 3],
                                    padding='same', 
                                    activation=tf.nn.relu,
            ...
            reg_pool6 = tf.layers.dropout(inputs=pool6, rate=0.5, training=is_training)
