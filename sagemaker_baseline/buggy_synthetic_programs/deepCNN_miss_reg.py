...
if __name__ == "__main__":
    ...
    train_data_loader = DataLoaderFromArrays(x_train, y_train.squeeze(), shuffle=True, one_hot=True, normalization=True)
    test_data_loader = DataLoaderFromArrays(x_test, y_test.squeeze(), shuffle=True, one_hot=True, normalization=True)
