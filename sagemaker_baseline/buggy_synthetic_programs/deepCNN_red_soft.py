...
class Model:
    ...
    def __init__(self, hook):
        ...
        self.loss = tf.losses.softmax_cross_entropy(self.labels, self.probabilities)
        hook.add_to_collection("losses", self.loss)
        self.test_loss = tf.losses.softmax_cross_entropy(self.labels, self.test_probabilities)
