...
if __name__ == "__main__":
    ...
    train_data_loader = DataLoaderFromArrays(X_train, y_train, problem_type='regression', shuffle=True, one_hot=False, normalization=False, homogeneous=False)
    test_data_loader =  DataLoaderFromArrays(X_test, y_test, problem_type='regression', shuffle=True, one_hot=False, normalization=False, homogeneous=False)
