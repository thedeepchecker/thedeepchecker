...
class LogisticRegression(object):
    ...
    def _build_model(self, n_features, n_classes):
        ...
        self.logits = tf.matmul(self.input_data, self.W_) + self.b_
    ...
    def _create_variables(self, n_features, n_classes):
        ...
        self.W_ = tf.Variable(tf.zeros([n_features, n_classes]), name='weight')
        self.b_ = tf.Variable(tf.zeros([n_classes]), name='bias')
