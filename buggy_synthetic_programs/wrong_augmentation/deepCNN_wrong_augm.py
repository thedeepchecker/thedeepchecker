...
class CustomDataLoader(data.AugmentedDataLoader):
    ...
    def augment_data(self, data, delta=0.1, proba=0.5):
        shape = data.shape
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='deep_CNN_wrong_augm', data=data_under_test, model=model_under_test, buffer_scale=10)
