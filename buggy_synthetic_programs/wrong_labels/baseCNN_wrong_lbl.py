'''
a common faulty situation is to get only the features shuffled.
'''
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    test_data_loader = CustomDataLoader(x_test, y_test, shuffle=True, one_hot=True, normalization=True)
    model = Model()
    ...
    checker = DeepChecker(name='base_CNN_corrupted_labels', data=data_under_test, model=model_under_test, buffer_scale=10)
