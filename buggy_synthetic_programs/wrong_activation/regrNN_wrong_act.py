'''
We set up softmax with just 1-dm output which could not work and the neural network will output
only one value.
'''
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='regrNN_wrong_act', data=data_under_test, model=model_under_test, buffer_scale=10)
