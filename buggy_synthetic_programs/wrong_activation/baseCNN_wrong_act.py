'''
We set up softmax as intermediary activation which is not appropriate.
'''
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='baseCNN_wrong_act', data=data_under_test, model=model_under_test, buffer_scale=10)
