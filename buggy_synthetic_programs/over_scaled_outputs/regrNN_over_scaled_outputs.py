'''
For this example, we deactivate the scaling of the continuous outputs(kind of normalization).
'''
import numpy as np
import pandas as pd
...
class Model:
    ...
    def build(self, features, out_dims, reuse=False, l1=0.0, l2=1e-6, training=True):
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='regrNN_over_scaled_outputs', data=data_under_test, model=model_under_test, buffer_scale=10)
