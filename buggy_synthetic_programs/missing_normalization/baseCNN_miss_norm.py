...
if __name__ == "__main__":
    ...
    data_loader_under_test = data.DataLoaderFromArrays(x_train, y_train, shuffle=True, one_hot=True, normalization=False)
    test_data_loader = data.DataLoaderFromArrays(x_test, y_test, shuffle=True, one_hot=True, normalization=False)
    model = Model()
    ...
    checker = DeepChecker(name='base_CNN_miss_norm', data=data_under_test, model=model_under_test, buffer_scale=10)
