...
class Model:
    ...
    def build(self, features, n_classes, l1=0.0, l2=1e-12):
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='base_CNN_low_lambda', data=data_under_test, model=model_under_test, buffer_scale=10)
