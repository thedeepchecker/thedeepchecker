'''
We reduce drastically the lambda of l2-norm cost aiming at removing the regularization.  
'''
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='regrNN_low_lambda', data=data_under_test, model=model_under_test, buffer_scale=10)
