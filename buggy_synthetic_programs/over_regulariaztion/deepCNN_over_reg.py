'''
As the deepCNN uses advanced regularization, we set up a high dropout rate in a way that hinders the learning. 
'''
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='deepCNN_high_drops', data=data_under_test, model=model_under_test, buffer_scale=10)
