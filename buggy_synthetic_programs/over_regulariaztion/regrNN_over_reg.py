'''
As the regrNN uses traditional regularization, we set up a high lambda for l2-norm in a way that hinders the learning. 
'''
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='regrNN_high_lambda', data=data_under_test, model=model_under_test, buffer_scale=10)
