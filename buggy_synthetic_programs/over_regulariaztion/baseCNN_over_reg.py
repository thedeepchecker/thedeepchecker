'''
As the baseCNN uses traditional regularization, we set up a high lambda for l2-norm in a way that hinders the learning. 
'''
import numpy as np
import pandas as pd
...
class Model:
    ...
    def build(self, features, n_classes, l1=0.0, l2=1e-1):
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='base_CNN_high_lambda', data=data_under_test, model=model_under_test, buffer_scale=10)
