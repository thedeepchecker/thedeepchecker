'''
A common beginner fault is to use MSE for classification problems.
'''
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='deep_CNN_poor_loss', data=data_under_test, model=model_under_test, buffer_scale=10)
