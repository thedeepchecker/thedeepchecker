'''
A beginner fault is to use CE for regression problem.
'''
import numpy as np
import pandas as pd
...
class Model:
    ...
    def __init__(self):
        ...
        self.loss = tf.reduce_mean(-tf.reduce_sum(self.labels*tf.log(tf.clip_by_value(self.outputs, 1e-10, 1.0))))
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='regrNN_poor_loss', data=data_under_test, model=model_under_test, buffer_scale=10)
