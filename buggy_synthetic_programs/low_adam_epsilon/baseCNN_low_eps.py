...
class Model:
    ...
    def __init__(self):
        ...
        self.train_op = tf.train.AdamOptimizer(learning_rate=0.1, epsilon=1e-16).minimize((self.loss+self.reg_loss))
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='base_CNN_low_epsilon', data=data_under_test, model=model_under_test, buffer_scale=10)
