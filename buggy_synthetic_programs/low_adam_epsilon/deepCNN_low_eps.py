...
class Model:
    ...
    def __init__(self):
        ...
        with tf.control_dependencies(update_ops):
            self.train_op = tf.train.AdamOptimizer(learning_rate=0.01, epsilon=1e-16).minimize(self.loss)
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='deep_CNN_low_epsilon', data=data_under_test, model=model_under_test, buffer_scale=10)
