...
class Model:
    ...
    def __init__(self):
        ...
        self.train_op = tf.train.GradientDescentOptimizer(0.5).minimize((self.loss+self.reg_loss))
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='base_CNN_high_lr', data=data_under_test, model=model_under_test, buffer_scale=10)
