'''
Here we remove the batchnorm layers which are necessary to stabilize the learning. 
'''
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='deep_CNN_miss_batchnorm', data=data_under_test, model=model_under_test, buffer_scale=10)
