'''
Here we deactivate the batchnorm layers updating of global means and vars 
which removes the batchnorm effect at the inference stage. 
'''
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='deep_CNN_miss_infer_batchnorm', data=data_under_test, model=model_under_test, buffer_scale=10)
