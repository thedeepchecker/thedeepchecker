...
class Model:
    ...
    def __init__(self):
        ...
        self.train_op = tf.train.AdamOptimizer(0.001).apply_gradients(grads_and_vars)
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='regrNN_flip_sign', data=data_under_test, model=model_under_test, buffer_scale=10)
