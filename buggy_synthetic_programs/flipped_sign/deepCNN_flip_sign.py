...
class Model:
    ...
    def __init__(self):
        ...
        with tf.control_dependencies(update_ops):
            ...
            self.train_op = tf.train.MomentumOptimizer(learning_rate=0.001,momentum=0.9).apply_gradients(grads_and_vars)
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='deep_CNN_flipped_sign', data=data_under_test, model=model_under_test, buffer_scale=10)
