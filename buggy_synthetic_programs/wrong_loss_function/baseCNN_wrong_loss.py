...
class Model:
    ...
    def __init__(self):
        ...
        self.loss = tf.reduce_sum(self.CE)
...
if __name__ == "__main__":
    ...
    checker = DeepChecker(name='base_CNN_wrong_loss', data=data_under_test, model=model_under_test, buffer_scale=10)
    checker.run_full_checks(implemented_ops=[('softmax',model.probabilities), ('CE',model.CE)])
